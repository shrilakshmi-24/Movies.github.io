...
},
{
    ...
    "plot": "Mrs Erlynne, the mother of Lady Windermere - her daughter does not know about her - wants to be introduced in society, so that she can marry Lord Augustus Lorton. Lord Windermere, who ...",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd796e",
    "title": "Safety Last!",
    "imdb": {
        "rating": 8.3,
        "votes": 11803,
...
},
{
    ...
    "plot": "Poor Ella Cinders is much abused by her evil step-mother and step-sisters. When she wins a local beauty contest she jumps at the chance to get out of her dead-end life and go to Hollywood, ...",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd8c6b",
...
},
{
    ...
    "plot": "In a juke joint, sharecropper Zeke falls for a beautiful dancer, Chick, but she's only setting him up for a rigged craps game. He loses $100, the money he got for the sale of his family's ...",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd91dc",
    "title": "The Big Trail",
    "imdb": {
        "rating": 7.3,
        "votes": 2312,
...
},
{
    ...
    "plot": "A convent girl is abducted and seduced by a prince before being sent off to a brothel in East Africa.",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd9336",
    "title": "King of Jazz",
    "imdb": {
        "rating": 7.5,
        "votes": 387,
    ...
    "plot": "This revue presents its numbers around the orchestra leader Paul Whiteman, besides that it shows in it's final number that the European popular music are the roots of American popular music...",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd8792",
...
},
{
    ...
    "plot": "Among the residents of a theatrical boarding house is the last member of a once great acting family, down on his luck. When an offer to star in a London \" Hamlet \" comes, he takes lessons ...",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd8aad",
...
},
{
    ...
    "plot": "Childhood friends are torn apart when one of them marries the woman the other once fiercely loved.",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd8319",
...
},
{
    ...
    "plot": "Young Harry is in love and wants to marry an actress, much to the displeasure of his family. Harry thinks that Bishop Armstrong knows nothing about love so Armstrong tells him the story of ...",
    "__typename": "movies"
},
{
    "_id": "573a1391f29313caabcd821b",
...
numPages=Math.ceil(movies.length/records_per_page)
function prevPage()
{
    if (current_page > 1) {
        current_page--;
...
function changePage(page){      
    ...
    var listing_table = document.getElementById("rows");
    var page_span = document.getElementById("page-no");
var count=1;
    if (page < 1) page = 1;
...
<th>Imdb</th>
<th>Tomatoes</th>
<th>Combined Ratings</th>
<th>View</th>   
</tr>  `
    for (var i = (page-1) * records_per_page; i < (page * records_per_page) && i < movies.length; i++)  {
    listing_table.innerHTML+=`<tr>
    <td>${i+1}</td>
        <td>${movies[i].title}</td>
        <td>${movies[i].imdb.rating}</td>
        <td>${movies[i].tomatoes.viewer.rating}</td>
        <td>${Math.round(movies[i].imdb.rating+movies[i].tomatoes.viewer.rating)}</td>
        <td>${movies[i].plot}</td>
        </tr>`;
    count=count+1;
    }
...
function sortBy(s) {
    if (s == null) {
        // return;
        alert("Select By which you want")
    }
...
function orderOp(opt) {
    ...
    order = opt.options[opt.selectedIndex].text;
